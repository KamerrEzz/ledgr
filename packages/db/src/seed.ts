  ...
  await db
    ...
    .values([
      ...
      },
      {
        ...
        tenantId: "a0000000-0000-4000-8000-000000000003",
  ...
  await db
    ...
    .values([
      ...
      },
      {
        ...
        resourceId: "b0000000-0000-4000-8000-000000000002",
        tenantId: "a0000000-0000-4000-8000-000000000001",
        name: "Single Domain",
        priceCents: 499n,
        currency: "USD",
      },
      {
        ...
        resourceId: "b0000000-0000-4000-8000-000000000003",
        tenantId: "a0000000-0000-4000-8000-000000000002",
        name: "Standard",
        priceCents: 15000n,
        currency: "USD",
      ...
      },
      {
        ...
        resourceId: "b0000000-0000-4000-8000-000000000004",
        tenantId: "a0000000-0000-4000-8000-000000000003",
        name: "Annual License",
        priceCents: 49900n,
        currency: "USD",
    ...
    .values([
      {
        ...
        tenantId: "a0000000-0000-4000-8000-000000000001",
        resourceVariantId: "c0000000-0000-4000-8000-000000000002",
        quantity: 1,
        totalCents: 9900n,
        currency: "USD",
        status: "paid",
      ...
      },
      {
        ...
        tenantId: "a0000000-0000-4000-8000-000000000001",
        resourceVariantId: "c0000000-0000-4000-8000-000000000001",
        quantity: 3,
        totalCents: 8700n,
        currency: "USD",
        status: "draft",
      ...
      },
      {
        ...
        tenantId: "a0000000-0000-4000-8000-000000000002",
        resourceVariantId: "c0000000-0000-4000-8000-000000000004",
        quantity: 2,
        totalCents: 30000n,
        currency: "USD",
  ...
  await db
    ...
    .values([
      ...
      },
      {
        ...
        orderId: "d0000000-0000-4000-8000-000000000003",
        tenantId: "a0000000-0000-4000-8000-000000000002",
        fromStatus: "draft",
        toStatus: "pending_payment",
